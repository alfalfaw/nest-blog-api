import { Controller, Get, Post, UseInterceptors, UploadedFile, Body, Param, Put, Delete, Query } from '@nestjs/common';
...
class WebsiteDto {
  ...
  //后台登陆密码
  @ApiProperty({ example: '1234', description: '登陆密码' })
  password: string
...
export class AppController {
  ...
  async upload(@UploadedFile('file') file) {
    ...
    return file
    //http://localhost:5000/website/upload
  ...
  async info() {
    ...
    //最近活动
    const Y = web_info.last_event.getTime()
  ...
  option() {
    return {
      ...
      column: [
        ...
        { prop: "password", label: "登陆密码", row: true },
        ...
        { prop: "avater", label: "头像", type: 'upload', listType: 'picture-img', row: true, action: 'website/upload', width: 120 },
        { prop: "logo", label: "logo", type: 'upload', listType: 'picture-img', row: true, action: 'website/upload', width: 120 },
